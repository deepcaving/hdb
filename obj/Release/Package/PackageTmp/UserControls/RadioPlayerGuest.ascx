...
<asp:Panel ID="pnlHeader" runat="server" Width="800px"  Height="54px" BackColor="#DEF5FF" BorderColor="#636DD8" >
    <table>
    ...
    <asp:Panel runat="server" ID="pnlBorder" BackColor="#636DD8" Width="796"  style="padding-left:5px;padding-top:5px; padding-bottom:5px;">
        <asp:Panel ID="pnlRadioPlayer" runat="server" Width="790px" BackColor="AliceBlue">
