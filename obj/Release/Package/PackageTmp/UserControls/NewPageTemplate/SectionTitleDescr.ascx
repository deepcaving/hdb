...
<asp:Panel runat="server" ID="Panel1" CssClass="modalPopup" DefaultButton="btnSave">
    <fieldset style="margin: 5px; width: 800px">
        ...
        <asp:TextBox ID="txtTrackName" runat="server" Width="500"></asp:TextBox>
        <asp:Label ID="lblRfvTrackName" runat="server" ForeColor="red" Text="Track's name required" 
        ...
        <asp:Label ID="lblRfvExtraDetails" runat="server" ForeColor="red" 
            Text="Too many words!" Visible="false"></asp:Label>
        <hr />
        <h3>
            Guidelines:</h3>
        <p>
